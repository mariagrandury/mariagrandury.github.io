...
<template>
  ...
  <Container class="bg-white dark:bg-gray-900">
    ...
    <div class="grid py-6 gap-y-3 lg:px-24 sm:px-12">
      ...
      <CardPaper
        title="Tairan Fu, Javier Conde, Gonzalo Martínez, María Grandury, Pedro Reviriego. Multiple Choice Questions: Reasoning Makes Large Language Models (LLMs) More Self-Confident Even When They Are Wrong, 2025."
